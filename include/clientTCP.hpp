...
namespace bh {
    ...
    /**
     * @brief Maximum line buffer size for network operations.
     * 
     * Defines the size of character buffers used for reading/writing data
     * from/to network sockets. Value of 1024 bytes is typical for line-oriented protocols.
     */
    ...
    public:
         ...
         * @endcode
         * 
         * @param ip Server IP address as a string (e.g., "192.168.1.1").
